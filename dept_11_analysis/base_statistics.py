...
def analyse_feature(df: pd.DataFrame, feature: str) -> pd.DataFrame:
    ...
    plt.ylabel("Counts")
    plt.savefig(f"dept_11_analysis/statistics_and_graphs/univariate/histogram_{feature}.jpg")
    plt.close()
    ...
    plt.axis("equal")
    plt.savefig(f"dept_11_analysis/statistics_and_graphs/univariate/pie_chart_{feature}.jpg")
    plt.close()
...
def plot_two_dimensional(df: pd.DataFrame, feature_1: str, feature_2: str):
    ...
    plt.grid(True)
    plt.savefig(f"dept_11_analysis/statistics_and_graphs/multivariate/2D_scatter_{feature_1}_{feature_2}.jpg")
    plt.close()
...
def plot_three_dimensional(df: pd.DataFrame, feature_1: str, feature_2: str, feature_3: str):
    ...
    plt.savefig(f"dept_11_analysis/statistics_and_graphs/multivariate/3D_scatter_{feature_1}_{feature_2}_{feature_3}.jpg")
    plt.close()